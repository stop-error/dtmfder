...
var ivrGreeting1 = &twiml.VoiceSay{
	Message: `Welcome the Jack dating interactive survey experience.
	...
	Your responses will not be recorded until the end of the survey experence.
	You may hang up at any time to end the survey and erase all survey answers.`,
}
